...
_USAGE = "setupService.py 'path/packageName' [ 'ServiceName_1' 'ServiceName_i' ]"
...
for serviceName in sys.argv[2:]:
    ...
    print('Edit the files {0}, {1}, {2}, {3} and {4}.'.format( 
        os.path.join(packageName, 'srv', 'Query{0}.srv'.format(upperName)),
