...
cmd_AU_debug = debugCmd({"userID":"testUser", "robotID":"testRobot"},
                        'cmd_AU_debug', "Authentication Message")

cmd_IN_debug = debugCmd({"type":ClientMsgTypes.INIT,
                         "data":{"userID":"testUser",
                                 "robotID":"testRobot",
                                 "key":"addKeyHere"}},
                        'cmd_IN_debug', "Initialization Message")
