...
download_ubuntu()
{
    packages=dialog,apt,apt-utils,resolvconf,iproute,inetutils-ping,net-tools,vim,dhcp3-client,ssh,lsb-release,language-pack-en,python-twisted-core,wget,python-openssl
