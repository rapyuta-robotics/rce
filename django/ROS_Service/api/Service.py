...
def HTTP_BAD_REQUEST(msg=''):
	""" Convert the error message into an HttpResponse object with the
		correct status code.
	"""
	return HttpResponseBadRequest(msg, content_type='text/plain')

def HTTP_INTERNAL_ERROR(msg=''):
	""" Convert the error message into an HttpResponse object with the
		correct status code.
	"""
	return HttpResponseServerError(msg, content_type='text/plain')

def HTTP_INTERNAL_FATAL_ERROR(msg=''):
	""" Convert the error message into an HttpResponse object with the
		correct status code.
	"""
	return HttpResponseServerError(msg, content_type='text/plain')
