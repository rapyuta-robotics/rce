...
# Before we start to import everything, check if:
...
# Run main function
main(reactor, cred, sys.argv[1], settings.MASTER_PORT, settings.BRIDGE_IF,
     settings.RCE_INTERNAL_PORT, settings.ROOTFS, settings.CONF_DIR,
