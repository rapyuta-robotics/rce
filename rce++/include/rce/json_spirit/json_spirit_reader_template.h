...
namespace json_spirit
{
    ...
    public:
        ...
        void new_name( Iter_type begin, Iter_type end )
        {
            ...
            if (name_[name_.length()-1] == Char_type('*'))
            {
    ...
    private:
        ...
        bool isBinary_;					// Control flag to distinguish string from binary
    };
    		...
    		std::vector< std::pair< typename Value_type::Config_type::String_type, typename Value_type::Config_type::Binary_type > > &binaries )
    {
        ...
        read_range_or_throw( posn_begin, posn_end, value, binaries );
    }
    		...
    		std::vector< std::pair< typename Value_type::Config_type::String_type, typename Value_type::Config_type::Binary_type > > &binaries )
    {
        ...
        return read_range( begin, s.end(), value, binaries );
    }
    		...
    		std::vector< std::pair< typename Value_type::Config_type::String_type, typename Value_type::Config_type::Binary_type > > &binaries )
    {
        ...
        return read_range( mp_iters.begin_, mp_iters.end_, value, binaries );
    }
    		...
    		std::vector< std::pair< typename Value_type::Config_type::String_type, typename Value_type::Config_type::Binary_type > > &binaries )
    {
        ...
        add_posn_iter_and_read_range_or_throw( mp_iters.begin_, mp_iters.end_, value, binaries );
    }
}
